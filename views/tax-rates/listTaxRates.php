    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="ml-auto">
                    <div class="dropdown">
                        <button class="btn btn-xs text-navy" type="button" id="taxRateTools" data-toggle="dropdown" aria-expanded="false" data-offset="-174">
                            <i class="fas fa-ellipsis-h"></i>
                        </button>
                        <div class="dropdown-menu" aria-labelledby="taxRateTools">
                            <a class="dropdown-item text-olive" href="add" id="add-tax-rate"><i class="fas fa-plus-circle mr-2"></i> নতুন ট্যাক্সের হার যোগ</a>
            ...
            <!-- /.card-header -->
            <form id="delete-tax-rate">
                <?= (new CSRF())->input('delete-tax-rate') ?>
            </form>
            <div class="card-body">
                <table class="table table-bordered table-striped table-hover projects" id="list-tax-rates-table">
                    <thead>
                        <tr role="row">
                            <th>ID</th>
                            <th>নাম</th>
                            <th>হার(%)</th>
                            <th>ট্যাক্সের প্রকার</th>
        ...
        <div class="modal-content">
            ...
            <form id="add-tax-rate-form">
                <div class="modal-body">
                    ...
                    <?= (new CSRF())->input('add-tax-rate-form') ?>
                </div>
